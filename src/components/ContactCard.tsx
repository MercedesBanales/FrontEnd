...
export default function ContactCard( { contact }: Prop) {
    ...
    return (
        <div className="flex justify-between rounded-3xl p-4 items-center bg-fuchsia-100 w-[49%]">
            ...
            <div className="flex flex-col gap-2">
                    <h2 className="font-bold text-lg text-black">{contact.name} {contact.surname}</h2>
